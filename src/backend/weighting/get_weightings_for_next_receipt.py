...
def get_weightings_for_next_receipt(DB_CONN, receipt_id: str) -> dict:
    """takes in receipt_id as a string and returns a dict of length 2. The 0 index of the tuple is a list of non-persist items. the 1 index of the tuple is list of persist items"""
    with DB_CONN:
        list_of_null_weightings_no_persistent_weights = DB_CONN.get_items_with_null_weightings_no_persistent_weights(receipt_id)
